  ...
  return (
    <main className="">
      <div className="flex max-w-full max-h-60  pb-2  items-center mb-[3.75rem] pt-[2.5rem]   ">
        ...
        <div className="flex justify-center items-center ml-[2.5rem]  ">
          <div className="flex items-center ">
            <img className="w-4 h-4" src={Cart} alt="cart" />
            <div clasName="w-[2.9375rem] h-[1.6875rem]">Cart</div>
          </div>
          <div className="flex justify-center text-[#F6f6f6] items-center  w-[7.25rem] h-10 rounded-[0.3125rem] bg-[#484FA2] ml-[0.88rem] ">
            <a
              className="flex justify-center items-center h-[ 2.5rem] pt-[0.88rem] pr-[1.75rem] pb-[0.88rem] pl-[1.75rem] "
              href="#"
            >
              Login
            </a>
          </div>
          <div className="flex justify-center text-[#F6f6f6] items-center  w-[7.25rem] h-10 rounded-[0.3125rem] bg-[#C40460] ml-[0.75rem] ">
            <a
              className="flex justify-center items-center h-[ 2.5rem] pt-[0.88rem] pr-[1.75rem] pb-[0.88rem] pl-[1.75rem] "
              href="#"
            >
